const DEFAULT_OPTIONS = {
  ...
  export default class Toast {
    ...
    set progressColor(value){
        this.#toastElem.style.setProperty("--progress-color", value)     
    }
    ...
    set variant(value){
        switch(value){
            case "success":
                ...
                this.#toastElem.style.setProperty("--progress-color", '#5cb85c')
                break;
            case "error":
                this.#toastElem.classList.add("error")
                this.#toastElem.style.setProperty("--progress-color", '#d9534f')
                break;
            case "warning":
                this.#toastElem.classList.add("warning")
                this.#toastElem.style.setProperty("--progress-color", '#f0ad4e')
                break;
            default:
                this.#toastElem.classList.add("normal")
        }
    }
    ...
    set style(value){
        console.log(value);
        this.#toastElem.style.cssText += value;
    }
